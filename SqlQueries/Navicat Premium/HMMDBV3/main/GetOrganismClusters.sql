SELECT DISTINCT HMM_Hits.HMM_Model, 
	HMM_Hits.HMM_Score, 
...
AND HMM_Hits.HMM_Model NOT LIKE '%FAD%' /* Filters out FADs */
AND HMM_Hits.HMM_Model NOT LIKE '%EchA%' /* Filters out EchAs */
AND HMM_Hits.HMM_Model NOT LIKE '%hsd4A%' /* Filters out hsd4As */
AND HMM_Hits.HMM_Model NOT LIKE '%Cyp%' /* Filters out Cyps */
AND HMM_Hits.HMM_Coverage >= 0.8
GROUP BY Proteins.Protein_Accession
HAVING max(HMM_Hits.HMM_Score)
ORDER BY Organisms.Organism_Phylogeny ASC, Organisms.Organism_Accession ASC, Organisms.Source ASC, Organisms.Accession_Type ASC, Proteins.Locus ASC