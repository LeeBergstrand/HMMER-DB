Find the E-value distribution of the HMM Hits for HMM families in HMMER-DB.
===========================================================================
```{r message = FALSE}
# Imports:
library(ggplot2)
...
#### We can then use ggplot to plot  E-value distribution of the HMM Hits for HMM families in the database:
